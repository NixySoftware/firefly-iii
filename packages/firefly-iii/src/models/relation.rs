...
pub struct Relation {
    ...
    /// The (company) name of the relation.
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// The salutation of the relation.
    ...
    /// The payment term of the relation.
    #[serde(
    ...
    pub free_text1: Option<Option<String>>,
    /// Free text field for the relation.
    #[serde(
        rename = "freeText2",
        default,
    ...
    pub free_text2: Option<Option<String>>,
    /// Free text field for the relation.
    #[serde(
        rename = "freeText3",
        default,
    ...
    pub free_text3: Option<Option<String>>,
    /// Free text field for the relation.
    ...
    /// Please use the dedicated member endpoints for club or association-members. Members will be removed from the relation endpoints in a future version.
    #[serde(
        rename = "isClubOrAssociationMember",
        skip_serializing_if = "Option::is_none"
    )]
    pub is_club_or_association_member: Option<i32>,
    ...
    pub do_not_receive_newsletters: Option<Option<i32>>,
    /// The ledger ID of this relation.
    #[serde(
        rename = "ledgerId",
        default,
        with = "::serde_with::rust::double_option",
...
impl Relation {
    pub fn new() -> Relation {
        Relation {
            ...
            free_text9: None,
            free_text10: None,
            is_club_or_association_member: None,

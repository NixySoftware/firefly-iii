...
pub struct Member {
    ...
    #[serde(rename = "memberNumber", skip_serializing_if = "Option::is_none")]
    pub member_number: Option<String>,
    /// The (company) name of the member.
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// The salutation of the member.
    #[serde(rename = "salutation", skip_serializing_if = "Option::is_none")]
    pub salutation: Option<String>,
    /// Male (`m`), female (`v`) or department ('a')
    #[serde(rename = "gender", skip_serializing_if = "Option::is_none")]
    pub gender: Option<Gender>,
    /// The primary address of the member.
    #[serde(rename = "address", skip_serializing_if = "Option::is_none")]
    pub address: Option<String>,
    /// The primary postal code of the member.
    #[serde(rename = "postalCode", skip_serializing_if = "Option::is_none")]
    pub postal_code: Option<String>,
    /// The primary city of the member.
    #[serde(rename = "city", skip_serializing_if = "Option::is_none")]
    pub city: Option<String>,
    /// The primary country of the member.
    ...
    /// The payment term of the member.
    #[serde(
    ...
    /// The IBAN number of the member.
    #[serde(rename = "iban", skip_serializing_if = "Option::is_none")]
    pub iban: Option<String>,
    /// The BIC number of the member.
    #[serde(rename = "bic", skip_serializing_if = "Option::is_none")]
    pub bic: Option<String>,
    /// Free text field for the member.
    #[serde(
        rename = "freeText1",
        default,
        with = "::serde_with::rust::double_option",
    ...
    /// The mandate ID of this member.
    #[serde(rename = "mandateId", skip_serializing_if = "Option::is_none")]
    pub mandate_id: Option<String>,
    /// The signing date of the mandate for this member.
    #[serde(

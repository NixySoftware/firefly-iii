...
#[async_trait]
pub trait AdministrationApi: Send + Sync {
    /// GET /v1/administration
    ///
    /// Get all administrations managed by the authorized accountant.
    async fn get_administrations(
        &self,
        params: GetAdministrationsParams,
    ) -> Result<models::AdministrationList, Error<GetAdministrationsError>>;

    /// GET /v1/administration/linked
    ///
    ...
    async fn get_linked_administrations(
        &self,
        params: GetLinkedAdministrationsParams,
    ) -> Result<models::AdministrationList, Error<GetLinkedAdministrationsError>>;
}

pub struct AdministrationApiClient {
    configuration: Arc<configuration::Configuration>,
}

impl AdministrationApiClient {
    pub fn new(configuration: Arc<configuration::Configuration>) -> Self {
        Self { configuration }
    }
}

/// struct for passing parameters to the method [`AdministrationApi::get_administrations`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct GetAdministrationsParams {
...
/// struct for passing parameters to the method [`AdministrationApi::get_linked_administrations`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct GetLinkedAdministrationsParams {
    /// The number of items to retrieve.
    pub limit: Option<i32>,
    /// The number of items to skip.
    pub offset: Option<i32>,
...
#[async_trait]
impl AdministrationApi for AdministrationApiClient {
    /// Get all administrations managed by the authorized accountant.
    async fn get_administrations(
        &self,
        params: GetAdministrationsParams,
    ) -> Result<models::AdministrationList, Error<GetAdministrationsError>> {
        let GetAdministrationsParams { limit, offset } = params;

        let local_var_configuration = &self.configuration;

        let local_var_client = &local_var_configuration.client;

        let local_var_uri_str = format!("{}/v1/administration", local_var_configuration.base_path);
            ...
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::AdministrationList`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::AdministrationList`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<GetAdministrationsError> =
    ...
    async fn get_linked_administrations(
        ...
        let GetLinkedAdministrationsParams { limit, offset } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetLinkedAdministrationsError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
...
/// struct for typed errors of method [`AdministrationApi::get_administrations`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetAdministrationsError {
    Status400(models::Error),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`AdministrationApi::get_linked_administrations`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetLinkedAdministrationsError {
    Status400(models::Error),
    Status401(),
    UnknownValue(serde_json::Value),
}

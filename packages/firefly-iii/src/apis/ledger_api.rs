...
pub trait LedgerApi: Send + Sync {
    ...
    ) -> Result<models::CreatedLedger, Error<CreateLedgerError>>;

    /// GET /v1/ledger/{id}/balance
    ///
    /// Get the balance on the given ledger with optional filters.
    async fn get_balance(
        &self,
        params: GetBalanceParams,
    ) -> Result<models::LedgerBalance, Error<GetBalanceError>>;
    ...
    ) -> Result<models::Ledger, Error<GetLedgerError>>;
    ...
    ) -> Result<models::LedgerList, Error<GetLedgersError>>;
    ...
    ) -> Result<(), Error<UpdateLedgerError>>;
}
...
/// struct for passing parameters to the method [`LedgerApi::create_ledger`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct CreateLedgerParams {
    pub create_ledger: Option<models::CreateLedger>,
}

/// struct for passing parameters to the method [`LedgerApi::get_balance`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct GetBalanceParams {
    ...
    /// Show the balance starting from this date. When provided, the resulting balance is the difference over the period, rather than the actual balance.
    pub from: Option<String>,
    /// Shows the active balance at this date. This date is inclusive.
    pub to: Option<String>,
}

/// struct for passing parameters to the method [`LedgerApi::get_ledger`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
...
/// struct for passing parameters to the method [`LedgerApi::get_ledgers`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct GetLedgersParams {
    ...
    /// The category of the ledger.
    pub category: Option<String>,
}

/// struct for passing parameters to the method [`LedgerApi::update_ledger`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct UpdateLedgerParams {
    pub id: i32,
    pub patch_ledger: Option<models::PatchLedger>,
}

#[async_trait]
impl LedgerApi for LedgerApiClient {
    /// Create a new ledger.
    async fn create_ledger(
        &self,
        params: CreateLedgerParams,
    ) -> Result<models::CreatedLedger, Error<CreateLedgerError>> {
        let CreateLedgerParams { create_ledger } = params;

        let local_var_configuration = &self.configuration;

        let local_var_client = &local_var_configuration.client;

        let local_var_uri_str = format!("{}/v1/ledger", local_var_configuration.base_path);
        ...
        local_var_req_builder = local_var_req_builder.json(&create_ledger);
            ...
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::CreatedLedger`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::CreatedLedger`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<CreateLedgerError> =
    ...
    async fn get_balance(
        ...
        if let Some(ref param_value) = cost_center_id {
            local_var_req_builder =
                local_var_req_builder.query(&[("costCenterId", &param_value.to_string())]);
        }
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::LedgerBalance`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::LedgerBalance`"
                    ))));
                }
            }
        } else {
    ...
    async fn get_ledger(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::Ledger`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::Ledger`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<GetLedgerError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_ledgers(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::LedgerList`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::LedgerList`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<GetLedgersError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn update_ledger(
        ...
        let UpdateLedgerParams { id, patch_ledger } = params;
        ...
        local_var_req_builder = local_var_req_builder.json(&patch_ledger);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateLedgerError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
...
/// struct for typed errors of method [`LedgerApi::create_ledger`]
...
/// struct for typed errors of method [`LedgerApi::get_balance`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`LedgerApi::get_ledger`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`LedgerApi::get_ledgers`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetLedgersError {
    Status400(models::Error),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`LedgerApi::update_ledger`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]

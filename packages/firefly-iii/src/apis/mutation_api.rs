...
pub trait MutationApi: Send + Sync {
    ...
    ) -> Result<models::CreatedMutation, Error<CreateMutationError>>;
    ...
    async fn get_mutation(
        &self,
        params: GetMutationParams,
    ) -> Result<models::Mutation, Error<GetMutationError>>;
    ...
    async fn get_mutations(
        &self,
        params: GetMutationsParams,
    ) -> Result<models::MutationList, Error<GetMutationsError>>;

    /// GET /v1/mutation/invoice/outstanding
    ///
    /// Get all outstanding invoices.
    async fn get_outstanding_invoices(
        &self,
        params: GetOutstandingInvoicesParams,
    ) -> Result<models::OutstandingInvoicesList, Error<GetOutstandingInvoicesError>>;
}

pub struct MutationApiClient {
    configuration: Arc<configuration::Configuration>,
}

impl MutationApiClient {
    pub fn new(configuration: Arc<configuration::Configuration>) -> Self {
        Self { configuration }
    }
}

/// struct for passing parameters to the method [`MutationApi::create_mutation`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct CreateMutationParams {
    pub create_mutation: Option<models::CreateMutation>,
}

/// struct for passing parameters to the method [`MutationApi::get_mutation`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct GetMutationParams {
    pub id: i32,
}

/// struct for passing parameters to the method [`MutationApi::get_mutations`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct GetMutationsParams {
    /// The number of items to retrieve.
    pub limit: Option<i32>,
    /// The number of items to skip.
    pub offset: Option<i32>,
    /// Only retrieves mutations of this type.
    pub r#type: Option<i32>,
    /// Only retrieves mutations with this number.
    pub id: Option<i32>,
    /// Only retrieves mutations with this description.
    pub description: Option<String>,
    /// Only retrieves mutations with this invoice number.
    pub invoice_number: Option<String>,
    /// Only retrieves mutations with this date.
    pub date: Option<String>,
}

/// struct for passing parameters to the method [`MutationApi::get_outstanding_invoices`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct GetOutstandingInvoicesParams {
    /// Retrieve creditors (`C`) or debtors (`D`).
    pub cred_deb: String,
    /// The number of items to retrieve.
    pub limit: Option<i32>,
    /// The number of items to skip.
    pub offset: Option<i32>,
    /// Only retrieve invoices with this number.
    pub invoice_number: Option<String>,
}

#[async_trait]
impl MutationApi for MutationApiClient {
    /// Create a new mutation.
    async fn create_mutation(
        &self,
        params: CreateMutationParams,
    ) -> Result<models::CreatedMutation, Error<CreateMutationError>> {
        let CreateMutationParams { create_mutation } = params;

        let local_var_configuration = &self.configuration;

        let local_var_client = &local_var_configuration.client;

        let local_var_uri_str = format!("{}/v1/mutation", local_var_configuration.base_path);
        ...
        local_var_req_builder = local_var_req_builder.json(&create_mutation);
            ...
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::CreatedMutation`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::CreatedMutation`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<CreateMutationError> =
    ...
    async fn get_mutation(
        ...
        let GetMutationParams { id } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::Mutation`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::Mutation`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<GetMutationError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_mutations(
        ...
        if let Some(ref param_value) = description {
            local_var_req_builder =
                local_var_req_builder.query(&[("description", &param_value.to_string())]);
        }
        if let Some(ref param_value) = invoice_number {
            local_var_req_builder =
                local_var_req_builder.query(&[("invoiceNumber", &param_value.to_string())]);
        }
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::MutationList`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::MutationList`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<GetMutationsError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_outstanding_invoices(
        ...
        let GetOutstandingInvoicesParams {
            cred_deb,
            limit,
            offset,
            invoice_number,
        ...
        local_var_req_builder = local_var_req_builder.query(&[("credDeb", &cred_deb.to_string())]);
        if let Some(ref param_value) = invoice_number {
            local_var_req_builder =
                local_var_req_builder.query(&[("invoiceNumber", &param_value.to_string())]);
        }
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::OutstandingInvoicesList`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::OutstandingInvoicesList`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<GetOutstandingInvoicesError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
...
/// struct for typed errors of method [`MutationApi::create_mutation`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateMutationError {
    Status400(models::Error),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`MutationApi::get_mutation`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetMutationError {
    Status404(models::Error),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`MutationApi::get_mutations`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetMutationsError {
    Status400(models::Error),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`MutationApi::get_outstanding_invoices`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetOutstandingInvoicesError {
    Status401(),
    UnknownValue(serde_json::Value),
}

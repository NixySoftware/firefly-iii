...
pub trait MemberApi: Send + Sync {
    ...
    ) -> Result<models::MembersResponse1, Error<CreateMemberError>>;
    ...
    ) -> Result<models::Member, Error<GetMemberError>>;
    ...
    ) -> Result<models::List, Error<GetMembersError>>;
...
/// struct for passing parameters to the method [`MemberApi::create_member`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct CreateMemberParams {
    pub member1: Option<models::Member1>,
}

/// struct for passing parameters to the method [`MemberApi::get_member`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
...
/// struct for passing parameters to the method [`MemberApi::get_members`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct GetMembersParams {
    ...
    /// Only retrieves members with this name.
    pub name: Option<String>,
    /// Only retrieves members with this e-mailadress.
    pub email: Option<String>,
    /// Only retrieves members from this city.
    pub city: Option<String>,
}

/// struct for passing parameters to the method [`MemberApi::update_member`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
...
impl MemberApi for MemberApiClient {
    ...
    async fn create_member(
        ...
        let CreateMemberParams { member1 } = params;

        let local_var_configuration = &self.configuration;

        let local_var_client = &local_var_configuration.client;

        let local_var_uri_str = format!("{}/v1/member", local_var_configuration.base_path);
        ...
        local_var_req_builder = local_var_req_builder.json(&member1);
            ...
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::MembersResponse1`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::MembersResponse1`"
                    ))));
                }
            }
        } else {
    ...
    async fn get_member(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::Member`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::Member`"
                    ))));
                }
            }
        } else {
    ...
    async fn get_members(
        ...
        if let Some(ref param_value) = member_number {
            local_var_req_builder =
                local_var_req_builder.query(&[("memberNumber", &param_value.to_string())]);
        }
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::List`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::List`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<GetMembersError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn update_member(
        ...
        let UpdateMemberParams { id, member1 } = params;
...
/// struct for typed errors of method [`MemberApi::create_member`]
...
/// struct for typed errors of method [`MemberApi::get_member`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`MemberApi::get_members`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`MemberApi::update_member`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]

...
pub trait ProductApi: Send + Sync {
    ...
    ) -> Result<models::CreateProduct1, Error<CreateProductError>>;
    ...
    ) -> Result<(), Error<DeleteProductError>>;
    ...
    ) -> Result<models::Product, Error<GetProductError>>;

    /// GET /v1/product/groups
    ///
    /// Get all product groups.
    async fn get_product_group(&self) -> Result<models::List1, Error<GetProductGroupError>>;
    ...
    ) -> Result<models::ProductList, Error<GetProductsError>>;
    ...
    ) -> Result<(), Error<UpdateProductError>>;
}
...
/// struct for passing parameters to the method [`ProductApi::create_product`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct CreateProductParams {
    pub create_product: Option<models::CreateProduct>,
}

/// struct for passing parameters to the method [`ProductApi::delete_product`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
...
/// struct for passing parameters to the method [`ProductApi::get_product`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
...
/// struct for passing parameters to the method [`ProductApi::get_products`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
...
/// struct for passing parameters to the method [`ProductApi::update_product`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct UpdateProductParams {
    pub id: i32,
    pub patch_product: Option<models::PatchProduct>,
}

#[async_trait]
impl ProductApi for ProductApiClient {
    /// Create a new product.
    async fn create_product(
        &self,
        params: CreateProductParams,
    ) -> Result<models::CreateProduct1, Error<CreateProductError>> {
        let CreateProductParams { create_product } = params;

        let local_var_configuration = &self.configuration;

        let local_var_client = &local_var_configuration.client;

        let local_var_uri_str = format!("{}/v1/product", local_var_configuration.base_path);
        ...
        local_var_req_builder = local_var_req_builder.json(&create_product);
            ...
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::CreateProduct1`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::CreateProduct1`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<CreateProductError> =
    ...
    async fn delete_product(
        ...
        let DeleteProductParams { id } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteProductError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_product(
        ...
        let GetProductParams { id } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::Product`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<GetProductError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_product_group(&self) -> Result<models::List1, Error<GetProductGroupError>> {
        ...
        let local_var_uri_str = format!("{}/v1/product/groups", local_var_configuration.base_path);
        let mut local_var_req_builder =
            local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::List1`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::List1`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<GetProductGroupError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_products(
        ...
        if let Some(ref param_value) = group_code {
            local_var_req_builder =
                local_var_req_builder.query(&[("groupCode", &param_value.to_string())]);
        }
        if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
            local_var_req_builder = local_var_req_builder
                .header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::ProductList`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ProductList`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<GetProductsError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn update_product(
        ...
        let UpdateProductParams { id, patch_product } = params;
        ...
        local_var_req_builder = local_var_req_builder.json(&patch_product);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateProductError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
...
/// struct for typed errors of method [`ProductApi::create_product`]
...
/// struct for typed errors of method [`ProductApi::delete_product`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`ProductApi::get_product`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`ProductApi::get_product_group`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetProductGroupError {
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`ProductApi::get_products`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`ProductApi::update_product`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
